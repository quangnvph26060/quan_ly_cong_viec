        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Tạo phiếu thu</h4>
                    </div>
                </div>
            </div>
            <!-- End page title -->
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <form id="receipt-form" action="{{ route('admin.receipt.store') }}" method="POST">
                                @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="amount" name="amount"
                                                    oninput="formatReceiptCurrency(this); checkFormValidity();"
                ...
                <div class="col-lg-4 col-md-4">
                    @include('admins.pages.receipt.customer_info')
                </div> <!-- end col -->
            ...
            function displayCustomerList(customers) {
                ...
                if (customers.length > 0) {
                    customers.forEach(customer => {
                        ...
                        customerItem.textContent = `${customer.name} (${customer.phone}) - ${customer.company_name}`;
