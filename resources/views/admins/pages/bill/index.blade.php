            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Danh sách phiếu báo giá</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group d-flex align-items-end">
                                        ...
                                        <a class="btn btn-success ml-2" href="{{ route('admin.bill.add') }}">
                                ...
                                {{-- <div class="col-lg-12">
                                    <div class="form-check mt-2">
                                        <input type="checkbox" class="form-check-input" id="show-today-bills">
                                        <label class="form-check-label" for="show-today-bills">Hiển thị phiếu chi của
                                            ngày hôm nay</label>
                                    </div>
                                </div> --}}
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="table-content">
                                @include('admins.pages.bill.table', [
                                    'bills' => $bills,
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#show-today-bills').on('change', function() {
            ...
            $('#search-btn').on('click', function() {
                ...
                let startDate = $('#start-date').val();
                let endDate = $('#end-date').val();
                let showToday = $('#show-today-bills').is(':checked');
                updateTableAndPagination(query, startDate, endDate, showToday);
            });
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.success) {
                                    ...
                                    .val(), $('#show-today-bills').is(':checked'));
                                } else {
            ...
            document.addEventListener('click', function(e) {
                if (e.target.matches('.client-name')) {
                    ...
                    fetch(`/admin/bill/client/${clientId}`)
