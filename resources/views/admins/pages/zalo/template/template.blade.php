    ...
    <div class="container mt-4">
        ...
        <div id="templateInfo">
            @if ($initialTemplateData)
                @include('admins.pages.zalo.template.template_detail', [
                    'responseData' => $initialTemplateData,
                ])
            @else
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#templateDropdown').change(function() {
                ...
                if (templateId) {
                    $.ajax({
                        url: '{{ route('admin.zalo.template.znsTemplateDetail') }}',
                        method: 'GET',
                        data: {
            ...
            $('#refreshButton').click(function() {
                $.ajax({
                    url: '{{ route('admin.zalo.template.znsTemplateRefresh') }}',
                    method: 'GET',
                    success: function(response) {
