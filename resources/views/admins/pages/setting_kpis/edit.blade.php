        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Sửa cài đặt KPI</h4>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <form action="{{route('admin.setting-kpi.update', ['id' => $kpi->id])}}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <input type="date" value="{{ $kpi->date }}" class="form-control" name="date" id="">
                                        ...
                                        {{-- <div class="mb-3">
                                            ...
                                            <select name="month" class="form-control" id="">
                                                @for ($i = 1; $i <= 12; $i++)
                                                    <option @if($kpi->month == $i){{'selected'}}@endif value="{{$i}}">
                                                        Tháng {{$i}}
                                                    </option>
                                                @endfor
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="year" class="form-control" id="">
                                                @for ($i = 2023; $i <= date("Y"); $i++)
                                                    <option @if($kpi->year == $i){{'selected'}}@endif value="{{$i}}">
                                                        Năm {{$i}}
                                                    </option>
                                                @endfor
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" value="{{ $kpi->post_new_num }}" name="post_new_num" />
                                            @error('post_new_num')
                                                <div class="invalid-feedback d-block">
                                                    {{$message}}
                                                </div>
                                        ...
                                        {{-- <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" value="{{ $kpi->post_edit_num }}" name="post_edit_num" />
                                            @error('post_edit_num')
                                                <div class="invalid-feedback d-block">
                                                    {{$message}}
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" value="{{ $kpi->post_publish_num }}" name="post_publish_num" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="user_id" class="form-control" data-trigger name="choices-single-groups"
                                                ...
                                                @foreach ($users as $item)
                                                    <option @if($item->id == $kpi->user_id){{'selected'}}@endif value="{{ $item->id }}">{{ $item->full_name }}</option>
                                                @endforeach
                                            </select>
                                            @error('user_id')
                                                <div class="invalid-feedback d-block">
