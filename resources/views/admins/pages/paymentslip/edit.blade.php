            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Sửa phiếu chi số {{ $paymentslip->id }}</h4>
                    </div>
                </div>
            </div>
            <!-- End page title -->
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <form id="paymentslip-form" action="{{ route('admin.paymentslip.update', ['id' => $paymentslip->id]) }}"
                                method="POST">
                                @method('PUT')
                                @csrf
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input value="{{ $paymentslip->note }}" type="text" id="note"
                                                    name="note" class="form-control" placeholder="Nhập nội dung thu">
                                            </td>
                                            <td>
                                                <input value="{{ number_format($paymentslip->amount) }}" type="text"
                                                    id="amount" name="amount" oninput="formatPaymentslipCurrency(this);"
                                                    class="form-control text-right" placeholder="Nhập số tiền">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                <input type="hidden" value="{{ $paymentslip->client_id }}" name="client_id"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div id="customer-info-name">{{ $paymentslip->client->name ?? '' }}</div>
                            </div>

                            <div class="form-group">
                                <label class="customer-label">Số điện thoại:</label>
                                <div id="customer-info-phone">{{ $paymentslip->client->phone ?? '' }}</div>
                            </div>

                            <div class="form-group">
                                <label class="customer-label">Địa chỉ:</label>
                                <div id="customer-info-address">{{ $paymentslip->client->address ?? '' }}</div>
                            </div>

                            <div class="form-group">
                                <label class="customer-label">Email:</label>
                                <div id="customer-info-email">{{ $paymentslip->client->email ?? '' }}</div>
                            </div>
                        </div>
                    </div>
