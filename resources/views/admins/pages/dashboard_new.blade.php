                        ...
                        <div class="card-body">
                            <div class="icon mb-3">
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-9">
                                        <p class="" style="margin-bottom: 2px"> Người dùng hoạt động</p>
                        ...
                        <div class="card-body">
                            <div class="icon mb-3">
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-9">
                                        <p class="" style="margin-bottom: 2px">ZNS thất bại</p>
                        ...
                        <div class="card-body">
                            <div class="icon mb-3">
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-9">
                                        <p class="" style="margin-bottom: 2px">ZNS thành công</p>
                        ...
                        <div class="card-body">
                            <div class="icon mb-3">
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-9">
                                        <p class="" style="margin-bottom: 2px">QA</p>
                                        ...
                                        <div class="card-body">
                                            <p class="d-flex" style="justify-content: space-between;">
                                                ...
                                                <span>
                                                    <b class="text text-success">
                                                        {{ $totalPostAssign . '/' . $user->kpis->sum('post_new_num') }}
                                                        bài
                                                    </b>
                                                    -
                                            ...
                                            <p>
                                                <b>Số bài hiện tại đang cần sửa: <span
                                                        class="text text-danger">{{ number_format(count($totalPostEditAndPublish->where('user_id', $user->id)->where('status', 2))) }}</span></b>
                                            </p>
                                            <p>
                                                <b>Số bài hiện tại đã sửa: <span
                                                        class="text text-danger">{{ number_format(count($totalPostEditAndPublish->where('user_id', $user->id)->where('status', 4))) }}</span></b>
                                            </p>
                                            <p>
                                                <b>Số bài hiện tại cần đăng: <span
                                                        class="text text-danger">{{ number_format(count($totalPostEditAndPublish->where('user_id', $user->id)->where('status', 3))) }}</span></b>
                                            </p>
                                        </div>
                                    </div>
                                </div>
