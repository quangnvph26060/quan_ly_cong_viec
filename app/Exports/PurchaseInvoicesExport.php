...
class PurchaseInvoicesExport implements FromCollection, WithMapping, WithStyles, ShouldAutoSize, WithStartRow, WithEvents
{
    private $index = 0;
    public function collection()
    {
        return InvoiceModel::where('status', 0)->get();
    }
